...
const Cart = () => {
  ...
  for (let i = 0; i < cartData.length; i++) {
    total += cartData[i].bookID.price * cartData[i].qty;
  }

  // get cart product
  const getCartProducts = () => {
    fetch("https://adventurous-puce-centipede.cyclic.app/user/cart_product", {
      method: "GET",
      headers: {
  ...
  const HandleDelete = (id) => {
    fetch(
      `https://adventurous-puce-centipede.cyclic.app/user/cart_product/delete/${id}`,
      {
        method: "DELETE",
        headers: {
          "Content-type": "application/json",
  ...
  const UpdateQty = (id, qty) => {
    fetch(
      `https://adventurous-puce-centipede.cyclic.app/user/cart_product/update/${id}`,
      {
        method: "PATCH",
        headers: {
          "Content-type": "application/json",
